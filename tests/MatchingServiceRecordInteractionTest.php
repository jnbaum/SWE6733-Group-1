...
class MatchingServiceRecordInteractionTest extends TestCase {
    ...
    public function testRecordInteraction_SuccessfullyAddsLike() {
        ...
        $success = $this->matchingService->RecordInteraction($this->testActingUserKey, $this->testOtherUserKey1, $isLiked);
    ...
    public function testRecordInteraction_SuccessfullyAddsDislike() {
        ...
        $success = $this->matchingService->RecordInteraction($this->testActingUserKey, $this->testOtherUserKey2, $isLiked);
