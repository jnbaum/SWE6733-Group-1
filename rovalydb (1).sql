...
--
-- Host: 127.0.0.1:3308
-- Generation Time: Jun 30, 2025 at 12:31 AM
...
(4, '1234@gmail.com', '$2y$10$9P.wK9EfznZHhyQpMgINOuMtPAlpLwO59LGTg5nfixfuokT/nRWWS', NULL, NULL),
(5, '1234@gmail.co', '$2y$10$zBUW0KbwgK3CZ7nEWjF1SuDS7/ElEEPDs9IdYtoWcSV6IDoGPtSsy', NULL, NULL),
(6, 'guest@1234', '$2y$10$8mQ2XdnqhJGRuRCn2AmjVucSpNu1xSa82P6lBUNGWQz095FNtsudS', NULL, NULL);
...
--
ALTER TABLE `adventure`
  MODIFY `AdventureKey` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT for table `adventurepreference`
--
ALTER TABLE `adventurepreference`
  MODIFY `AdventurePreferenceKey` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `interaction`
  MODIFY `InteractionKey` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `message`
--
ALTER TABLE `message`
  MODIFY `MessageKey` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `user`
  MODIFY `UserKey` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
