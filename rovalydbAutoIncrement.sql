...
--
-- Host: 127.0.0.1:3308
-- Generation Time: Jul 11, 2025 at 01:28 AM
...
INSERT INTO `interaction` (`InteractionKey`, `ActingUserKey`, `OtherUserKey`, `IsLiked`) VALUES
(1, 30, 1, b'1'),
(2, 30, 1, b'1'),
(3, 30, 1, b'1'),
(4, 30, 3, b'1'),
...
(3, 17, 1, 6, 'Test', '2025-07-03 21:21:00'),
(4, 18, 1, 7, 'Hello!', '2025-07-03 21:34:16'),
(5, 18, 1, 7, 'Test', '2025-07-03 21:53:23'),
(8, 1, 2, 8, 'hello', '2025-07-03 22:02:54'),
(10, 1, 2, 8, 'hello', '2025-07-03 22:03:49'),
(11, 1, 2, 8, 'hello', '2025-07-03 22:04:54'),
(12, 1, 2, 8, 'hello', '2025-07-03 22:04:54'),
(13, 1, 2, 8, 'hello', '2025-07-03 22:52:22'),
(14, 1, 2, 8, 'hello', '2025-07-03 22:52:22'),
(15, 21, 1, 9, 'Test', '2025-07-03 22:55:26'),
(16, 1, 2, 8, 'hello', '2025-07-03 23:10:49'),
(17, 1, 2, 8, 'hello', '2025-07-03 23:10:49'),
(18, 22, 1, 10, 'Test', '2025-07-05 15:24:38'),
(19, 22, 17, 11, 'Hello!', '2025-07-05 15:32:04'),
(20, 23, 17, 12, 'Test', '2025-07-05 15:37:28'),
(21, 23, 17, 12, 'Test', '2025-07-05 15:47:47'),
(22, 23, 17, 12, 'Hello!', '2025-07-05 15:57:47'),
(23, 17, 23, 12, 'Nice to meet you!', '2025-07-05 15:58:11'),
(24, 17, 1, 6, 'Test', '2025-07-06 23:13:15'),
(25, 27, 1, 13, 'Hello!', '2025-07-08 19:13:42');
...
(17, 17, 'user_17.jpg', '2025-07-03 21:20:48'),
(18, 18, 'user_18.jpg', '2025-07-03 21:33:52'),
(19, 19, 'user_19.jpg', '2025-07-03 22:13:51'),
(20, 21, 'user_21.jpg', '2025-07-03 22:55:17'),
(21, 22, 'user_22.jpg', '2025-07-05 15:23:11'),
(22, 23, 'user_23.jpg', '2025-07-05 15:35:53');
...
(17, 17, 'https://instagram.com'),
(18, 18, 'https://instagram.com'),
(19, 19, 'https://instagram.com'),
(20, 21, 'https://instagram.com'),
(21, 22, 'https://instagram.com'),
(22, 23, 'https://instagram.com'),
(23, 27, 'https://instagram.com'),
(24, 28, 'https://instagram.com'),
(25, 29, 'https://instagram.com'),
(26, 30, 'https://instagram.com');
...
(17, 'test@1234', '$2y$10$G38jpxyuAR/uzCQU8NcZMuhIK.2btmLvUv6MVZypL7BqpUSPt/efG', 'Jake Schramm', 'Test'),
(18, 'test3@1234', '$2y$10$aFAsQJO866KKvcm0WQGJCOiHic8fCaF2i.8cDlhEFwRz9UroKhhUC', 'Test 2', 'Test'),
(19, 'test5@1234', '$2y$10$8RQfYzq.yAbeWcFvdPwiE.iS3mSjxRjhFXxbfaXjiqTdpCIU8tE8a', '1 1', 'Test'),
(20, 'TestUser@mail.com', '$2y$10$Cp.drs1wMGLIOOeN8pqEYee7l6NBd2LlyP63.mow1Fh33AC854Et2', NULL, NULL),
(21, 'testexample@1234', '$2y$10$Jo1fBsb0e4OmNbkcXepOgOzoUGqOcflJsIU3Q6MvUI9ECVSitjGtC', '1 2', 'Test'),
(22, 'test6@1234', '$2y$10$hG25yl1fW/BUWI7LH2sPVeGQV9aYTaRP5x4LH362WuQ3uoGHFnUOK', 'Jake Schramm', 'Test'),
(23, 'test7@1234', '$2y$10$LgAAQ2eEaFk2JKkmSv8PeeicDuLwik6giH8mtS1z5VxxkTcL26TES', 'Jake Schramm', 'Test'),
(24, 'test', '$2y$10$R4LA/rM0wpUJ2ljsyF7MFuErzx65MYs.vGXx3Pu.w1rzQkzELLD8C', NULL, NULL),
(25, 'test@gmail.com', '$2y$10$R9v3VVMmx7AGzW3340M0BORtMBLsIE.oqyT3UOPk/rKzjpc..57Ze', NULL, NULL),
(26, 'hello@1234', '$2y$10$wnc.THtTdf6uQ7F5VGD65.FQMMoFYcagyPkIZ3B6xJFyFYx41saWy', NULL, NULL),
(27, 'rov@1234', '$2y$10$YSHioJe/yF.8/XT9KhRNluJNNnFAyjq2IRNGU7jVb32kkD7FfyLx2', 'Hello 1', 'Test'),
(28, 'hi@1234', '$2y$10$BSACyrTV36k/gdQHIRbMfeXKA08YHNZGtOERDK.z0GyDoaNfrHmIO', 'Hello There', 'Test'),
(29, 'test10@1234', '$2y$10$NPTxhBXcPJtttcM0cBXd..Ah5ZmWuPU0pUQg5N3c4LHwZNSjcCGF6', 'Jake Schramm', 'Test'),
(30, 'test12@1234', '$2y$10$iC057fuFQQUAtZzzoB3owus6vP21qc/ygLNqe6D1JVbEC0NmbctbC', 'Jake Schramm', 'Test');
...
--
ALTER TABLE `adventure`
  MODIFY `AdventureKey` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT for table `adventurepreference`
--
ALTER TABLE `adventurepreference`
  MODIFY `AdventurePreferenceKey` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
...
--
ALTER TABLE `chatroom`
  MODIFY `ChatRoomKey` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `interaction`
--
ALTER TABLE `interaction`
  MODIFY `InteractionKey` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `message`
--
ALTER TABLE `message`
  MODIFY `MessageKey` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `milerange`
--
ALTER TABLE `milerange`
  MODIFY `MileRangeKey` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `milerangetype`
--
ALTER TABLE `milerangetype`
  MODIFY `MileRangeTypeKey` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `photo`
--
ALTER TABLE `photo`
  MODIFY `PhotoKey` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `profilephoto`
  MODIFY `ProfilePhotoKey` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `socialmedialink`
--
ALTER TABLE `socialmedialink`
  MODIFY `SocialMediaLinkKey` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `UserKey` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
